...
QUERIES: dict[str, str] = {
    ...
    "tzatziki_batonnets_legumes": "tzatziki dip vegetables",
    "bruschetta_tomate_basilic": "bruschetta tomato basil",
    "crepes_sucrees": "crepes plate sugar",
    "riz_au_lait_vanille": "rice pudding bowl",
    "compote_pommes_cannelle": "apple sauce bowl cinnamon",
    "salade_fruits_frais": "fresh fruit salad bowl",
    # cuisine française
